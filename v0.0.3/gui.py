...
class SORApp(tk.Tk):
    ...
    def do_compress(self, folder, out_path, file_list):
        try:
            from compressor import compress_to_sor_parallel
            ...
            compress_to_sor_parallel(file_list, out_path, root_dir=folder, progress_callback=progress_callback)
